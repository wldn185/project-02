  ...
  <!-- 1.제이쿼리 라이브러리 연결 -->
  <script src="../../project2/script/jquery-3.7.1.js"></script>
  <script src="https://code.jquery.com/ui/1.13.2/jquery-ui.js"></script>
  <!-- 2. 제이쿼리 메인 -->
  <script defer src="../skin/board/notice2/script/common_notice.js"></script>
  <script defer src="../../project2/script/main.js"></script>
  <!-- 3. 제이쿼리 쿠키플러그인 -->
  <script src="../../project2/script/jquery.cookie.js"></script>
  <!-- Swiper JS -->
  ...
  <header>
    <!-- 메인로고 -->
    <h1>
      <a href="../../project2/index.html" title="메인페이지로 바로가기">
        <img src="../../project2/images/logo.png" alt="상단로고">
      </a>
    </h1>
    <!-- 모바일 로그인 버튼 -->
    ...
    <nav class="m_gnb">
      ...
      <ul class="m_gnb_inner">
        <li><a href="#none" title="회사소개">회사소개<i class="fas fa-angle-down"></i></a>
          <ul class="m_sub">
            <li><a href="../../project2/about.html" title="회사소개">회사소개</a></li>
        ...
        <li><a href="#none" title="브랜드">브랜드<i class="fas fa-angle-down"></i></a>
          <ul class="m_sub">
          <li><a href="../../project2/brand.html" title="브랜드소개">브랜드소개</a></li>
        ...
        <li><a href="#none" title="esg">ESG<i class="fas fa-angle-down"></i></a>
          <ul class="m_sub">
            <li><a href="../../project2/esg.html" title="esg">ESG</a></li>
      ...
      <a href="../../project2/index.html"><img src="../../project2/images/logo2.png" alt="로고"></a>
      <div class="h_lang">
    ...
    <nav class="gnb">
      <ul>
        ...
        <li class="menu menu_about">
          <a class="menu_name" href="../../project2/about.html" title="회사소개페이지로 바로가기">회사소개</a>
          <div class="sub_menu">
            <div class="sub_leftbox">
              ...
              <a href="../../project2about.html" class="btn_viewmore"><img src="../../project2/images/button/btn_viewmore.png" alt=""></a>
            </div>
        ...
        <li class="menu menu_brand">
          <a class="menu_name" href="../../project2/brand.html" title="브랜드소개페이지로 바로가기">브랜드</a>
          <div class="sub_menu">
            <div class="sub_leftbox">
              <h5>브랜드</h5>
              <p>아모레퍼시픽의 브랜드는 전통적인 뷰티의 영역을 과감히 넘고자 노력합니다. 창조적인 아이디어에 기술 혁신을 더해 효능의 가치를 높인 차세대 뷰티 제품을 만들고, 건강한 삶을 돌보기 위한
                솔루션을 제안합니다. 전 세계 고객과 직접 소통하며 아름다움을 향한 여정을 이어갑니다.</p>
              <a href="../../project2/brand.html" class="btn_viewmore"><img src="../../project2/images/button/btn_viewmore.png" alt=""></a>
            </div>
            <span class="vertical_line"></span>
            <div class="sub_rightbox">
              <ul>
                <li>
                  <div class="sub_rightbox_inner inner_info act">
                    <a href="#none" title="이미지"><img src="../../project2/images/brand/brand_cont_beautiful_01.png" alt=""></a>
                    <a href="#none" title="이미지"><img src="../../project2/images/brand/brand_cont_beautiful_22.png" alt=""></a>
                    <a href="#none" title="이미지"><img src="../../project2/images/brand/brand_cont_beautiful_12.png" alt=""></a>
                    <a href="#none" title="이미지"><img src="../../project2/images/brand/brand_cont_beautiful_26.png" alt=""></a>
                    <a href="#none" title="이미지"><img src="../../project2/images/brand/brand_cont_beautiful_11.png" alt=""></a>
                    <a href="#none" title="이미지"><img src="../../project2/images/brand/brand_cont_beautiful_13.png" alt=""></a>
                    <a href="#none" title="이미지"><img src="../../project2/images/brand/brand_cont_beautiful_24.png" alt=""></a>
                    <a href="#none" title="이미지"><img src="../../project2/images/brand/brand_cont_beautiful_15.png" alt=""></a>
                    <a href="brand.html" title="브랜드페이지로 바로가기"><img src="../../project2/images/button/btn_more_redline.png"
                        alt=""></a>
                  </div>
                </li>
                <li>
        ...
        <li class="menu menu_product">
          ...
          <div class="sub_menu">
            <div class="sub_leftbox">
              ...
              <p>아모레퍼시픽의 브랜드는 전통적인 뷰티의 영역을 과감히 넘고자 노력합니다. 창조적인 아이디어에 기술 혁신을 더해 효능의 가치를 높인 차세대 뷰티 제품을 만들고, 건강한 삶을 돌보기 위한
                솔루션을 제안합니다. 전 세계 고객과 직접 소통하며 아름다움을 향한 여정을 이어갑니다.</p>
              <a href="product.html" class="btn_viewmore"><img src="../../project2/images/button/btn_viewmore.png" alt=""></a>
            </div>
            <span class="vertical_line"></span>
            <div class="sub_rightbox">
              <ul>
        ...
        <li class="menu menu_esg">
          <a class="menu_name" href="../../project2/esg.html" title="esg소개페이지로 바로가기">ESG</a>
          <div class="sub_menu">
            <div class="sub_leftbox">
              <h5>ESG</h5>
              <p>LG생활건강은 2050년 탄소중립을 실현하기 위한 다양한 감축과제를 단계적으로 도입하여 미래세대를 위한 환경적 책임을 다하고 이를 통해 고객가치를 확대해 나가겠습니다.</p>
              <a href="../../project2/esg.html" class="btn_viewmore"><img src="../../project2/images/button/btn_viewmore.png" alt=""></a>
            </div>
            <span class="vertical_line"></span>
            <div class="sub_rightbox">
              <ul>
        ...
        <li class="menu menu_notice">
          <a class="menu_name" href="http://duaal433.dothome.co.kr/bbs/bbs/board.php?bo_table=notice"
            title="공지사항페이지로 바로가기">공지사항</a>
          <div class="sub_menu">
            <div class="sub_leftbox">
              <h5>공지사항</h5>
              <p>LG생활건강은 늘 새로운 소식과 즐거운 이야기로 고객 여러분을 찾아 갑니다. 뷰티/생활/건강 각 분야별 생활속의 도움이 되는 정보를 제공 합니다.</p>
              <a href="http://duaal433.dothome.co.kr/bbs/bbs/board.php?bo_table=notice" class="btn_viewmore"><img
                  src="../../project2/images/button/btn_viewmore.png" alt=""></a>
            </div>
            <span class="vertical_line"></span>
            <div class="sub_rightbox">
              <ul>
        ...
        <li class="menu menu_cus">
          ...
          <div class="sub_menu">
            <div class="sub_leftbox">
              ...
              <a href="cus.html" class="btn_viewmore"><img src="../../project2/images/button/btn_viewmore.png" alt=""></a>
            </div>
            <span class="vertical_line"></span>
            <div class="sub_rightbox">
              <ul>
