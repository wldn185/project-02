...
$(document).ready(function () {
  ...
  $(window).scroll(function () {
    ...
    let second_sect_offset = $('body section:nth-of-type(1)').offset().top;
  ...
  $('.btn_viewmore img').mouseenter(function(){
    $(this).attr('src', '../../project2/images/button/btn_viewmore_red.png');
  })
  .mouseleave(function(){
    $(this).attr('src', '../../project2/images/button/btn_viewmore.png');
  })
  ...
  $('.btn_top').hover(function(){
    $(this).find('img').attr('src','../../project2/images/button/btn_top_red.png');
  }, function(){
    $(this).find('img').attr('src','../../project2/images/button/btn_top.png');
  });
  $('.btn_cs img').hover(function(){
    $(this).attr('src','../../project2/images/button/btn_cus_red.png');
  }, function(){
    $(this).attr('src','../../project2/images/button/bnt_cus.png');
  });
  // 상담사버튼 클릭시 전화번호
